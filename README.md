...
Stats de **Deadlock** en español, hechas pa' la comunidad de LATAM y España.

Una app de escritorio gratis y open source pa' ver win rates, builds, items y leaderboards sin tener que estar peleando con páginas en inglés ni con data que nunca está actualizá.
...
1. **Todo está en inglés.** Las herramientas de stats que hay son buenas, pero pa' explicarle un build a mi chat en español yo tenía que estar traduciendo nombres de items al vuelo. Un dolor de cabeza.
...
No es perfecta y la sigo trabajando entre stream y stream, pero hace lo que necesito y espero que a ti también te sirva.
...
- **Errores / Logs** — una pestaña pa' ver qué pasó si algo falla. Si encuentras un bug, le das a "Copiar sesión" y me lo mandas. Así arreglo las cosas más rápido.

Todo en **español por defecto**, con un botón pa' cambiar a inglés si lo prefieres.
...
### Pa' los que quieren correrlo desde el código
...
MIT. Haz lo que quieras con esto, solo deja el crédito. Mira el archivo [LICENSE](LICENSE) pa' los detalles.
